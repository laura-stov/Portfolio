# Portfólio de Tecnologia | Laura Santos Oliveira

Bem-vindo(a) ao meu espaço de desenvolvimento técnico. Como estudante de Ciência da Computação, construo projetos que unem a solidez da Engenharia de Software com a inteligência da Análise de Dados. 

Meu objetivo é aplicar minha base técnica (Python, SQL, C#, Java) para criar soluções que transformam dados brutos em decisões estratégicas e automação eficiente.
